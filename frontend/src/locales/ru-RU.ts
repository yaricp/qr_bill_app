...
export default {
  ...
  attantion: "Внимание! приложение находится на стадии тестирования и поэтому администрация не несет никакой  ответственности за сохранность ваших данных. Продолжая использовать это приложение Вы берете на себя все риски связанные с потерей или не верно обработанных данных.",
  agreement: {
