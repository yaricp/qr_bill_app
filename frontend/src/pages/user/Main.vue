        ...
        <div class="row">
            ...
            <div class="col">
                <button 
                    ...
                    @click="goToScan"
                >
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-qr-code-scan" viewBox="0 0 16 16">
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    components: { NumberMonthAnalytics, CircleAnalytics },
    computed: {
      authToken() {
