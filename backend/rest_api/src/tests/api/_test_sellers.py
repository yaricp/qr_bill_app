...
def test_create_seller(test_client, auth_headers):
    ...
    response = test_client.post(
        "/api/v1/sellers/", json=new_seller_data, headers=auth_headers
    )
...
def test_update_seller(test_client, create_sellers, auth_headers):
    ...
    response = test_client.put(
        f"/api/v1/sellers/{seller_id}", json=updated_seller_data, headers=auth_headers
    )
...
def test_count_bills_by_name(test_client, auth_headers):
    ...
    response = test_client.get(
        "/api/v1/sellers/count_bills_by_name/", headers=auth_headers
    )
...
def test_summ_bills_by_name(test_client, auth_headers):
    ...
    response = test_client.get(
        "/api/v1/sellers/summ_bills_by_name/", headers=auth_headers
    )
...
def test_count_goods_by_name(test_client, auth_headers):
    ...
    response = test_client.get(
        "/api/v1/sellers/count_goods_by_name/", headers=auth_headers
    )
