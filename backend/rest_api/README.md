...
- [**alembic/**](/files/Projects/qr_bill_app/backend/rest_api/alembic/README.md): Contains database migration scripts managed by Alembic.
- , : Poetry configuration files for dependency management.
- [**scripts/**](/files/Projects/qr_bill_app/backend/rest_api/scripts/README.md): Utility scripts for various development and operational tasks.
- [**src/**](/files/Projects/qr_bill_app/backend/rest_api/src/README.md): Contains the main source code of the FastAPI application.
    - [**api/**](/files/Projects/qr_bill_app/backend/rest_api/src/api/README.md): Defines API routes, configurations, dependencies, and middleware.
    - [**app/**](/files/Projects/qr_bill_app/backend/rest_api/src/app/README.md): Holds the core application business logic, entities, and metrics definitions.
    - [**infra/**](/files/Projects/qr_bill_app/backend/rest_api/src/infra/README.md): Manages infrastructure-related components such as database connections, email services, gRPC server integration, and Telegram client.
    - [**tests/**](/files/Projects/qr_bill_app/backend/rest_api/src/tests/README.md): Contains unit and integration tests for the API and application logic.
