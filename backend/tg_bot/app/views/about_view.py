...
def about_view(
    ...
    dict_text = {
        "ru": " Идея этого проекта заключается в том чтобы "\
                "дать возможность вам проанализировать ваши покупки "\
                ...
                "1. регистрация пользователя(присходить автоматически, когда"\
                " вы запускаете этот бот)\n"\
                "2. генерация временной ссылки для входа в веб приложениею\n"\
