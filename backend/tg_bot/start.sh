...
cp /bot/grpc_client/grpc_pb2_grpc.py /bot/grpc_client/grpc_pb2_grpc.py.orig
sed 's/import grpc_pb2/from . import grpc_pb2/g' /bot/grpc_client/grpc_pb2_grpc.py.orig > /bot/grpc_client/grpc_pb2_grpc.py
